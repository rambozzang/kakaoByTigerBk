...
public class PartialCancelTest02 {
	@LocalServerPort
	private int port;
	...
	@Order(1)
	@Test
	@DisplayName("Case02 1번째 => 20,000원 (909원) 결제 성공 테스트.")
	...
	@Order(2)
	@Test
	@DisplayName("Case02 2번째 => 10,000원 (0원) 취소 성공 테스트.")
	...
	@Order(3)
	@Test
	@DisplayName("Case02 3번째 => 10,000원 (0원) 취소 실패 테스트.")
	public void testCase03() throws Exception {
		...
		assertThat(errorVO.getStatus()).isEqualTo("9006");		// 오류 상세 코드 : 마지막 취소처리할 VAT금액 상이하여 취소 할수 없습니다.
	...
	@Order(4)
	@Test
	@DisplayName("Case02 4번째 => 10,000원 (909원) 취소 성공  테스트.")
